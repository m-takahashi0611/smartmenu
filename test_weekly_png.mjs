...
const testMenus = [
  { breakfast: "鮭の塩焼き・ほうれん草のおひたし・卵焼き・豆腐とわかめのお味噌汁", lunch: "鶏むね肉のピカタ・ブロッコリーと卵のサラダ", dinnerOptions: [{name:"鶏ひき肉と豆腐のヘルシーハンバーグ"},{name:"鮭のムニエル・レモンバターソース"},{name:"豚の生姜焼き・キャベツの千切り"}] },
  { breakfast: "鮭の塩焼き・ほうれん草のおひたし", lunch: "鶏むね肉のピカタ・ブロッコリーと卵の和え物", dinner: "鶏むね肉の唐揚げ定食" },
  { breakfast: "鮭の塩焼き・ほうれん草のおひたし", lunch: "鶏むね肉の塩麹焼き・ブロッコリーと卵の和え物", dinner: "鶏むね肉の棒棒鶏・中華風春雨サラダ" },
  { breakfast: "鮭の塩焼き・ほうれん草のおひたし・納豆", lunch: "鶏むね肉のピカタ・ブロッコリーと卵の和え物", dinner: "鶏むね肉のピカタ・ほうれん草と卵の和え物" },
  { breakfast: "鮭の塩焼き・ほうれん草のおひたし・納豆", lunch: "鶏むね肉のピカタ・ほうれん草のおひたし", dinner: "鶏むね肉の棒棒鶏・きゅうりとワカメの酢の物" },
  { breakfast: "鮭の塩焼き・ほうれん草のおひたし・納豆", lunch: "鶏むね肉のピカタ・ブロッコリーと卵のサラダ", dinner: "豚こま切れ肉とキャベツの生姜焼き・きゅうりと大根の浅漬け" },
  { breakfast: "鮭の塩焼き・ほうれん草のおひたし・卵焼き", lunch: "鶏むね肉のピカタ・ブロッコリーとツナの和え物", dinner: "鶏むね肉のピカタ・ほうれん草と卵の和え物" },
];
